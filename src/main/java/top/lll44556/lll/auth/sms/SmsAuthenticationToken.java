...
public class SmsAuthenticationToken extends AbstractAuthenticationToken {
     ...
     * unauthenticated <code>SmsAuthenticationToken</code>.
     * @param principal
     * @param credentials
     * @return SmsAuthenticationToken with false isAuthenticated() result
     *
     * @since 5.7
     */
    ...
    /**
     * This factory method can be safely used by any code that wishes to create a
     * authenticated <code>SmsAuthenticationToken</code>.
     * @param principal
     * @param credentials
     * @return SmsAuthenticationToken with true isAuthenticated() result
     *
     * @since 5.7
     */
