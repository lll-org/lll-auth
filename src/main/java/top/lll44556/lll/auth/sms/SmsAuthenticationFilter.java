...
public class SmsAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    // 表单提交密码
    public static final String SPRING_SECURITY_FORM_PASSWORD_KEY = "captcha";
    // 表单方式和地址
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        SmsAuthenticationToken authRequest = SmsAuthenticationToken.unauthenticated(username,
                password);
    ...
    public void setPasswordParameter(String passwordParameter) {
        Assert.hasText(passwordParameter, "captcha parameter must not be empty or null");
